...
The invertebrate barcode sequences are available from Genbank under accessions KP420745 - KP422464 (COI barcodes) and KT439401 - KT440856 (28S barcodes). The sequences used in this analysis are also included in this repository ("COI_1611_barcode_sequences.fasta" and "28S_1282_barcode_sequences.fasta" in "./Invert_DNA_barcode_data/". The soil DNA metabarcoding data is a subset of the multigene metabarcoding dataset generated by Drummond et al., 2015. Evaluating a multigene environmental DNA approach for biodiversity assessment. GigaScience, 4(1), 46. http://doi.org/10.1186/s13742-015-0086-1
